...
public class FindOnArtistMessageProcessorDebuggable
    extends FindOnArtistMessageProcessor
    implements DebugInfoProvider
{


    public FindOnArtistMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("term", "Term", (java.lang.String.class), term, muleEvent));
